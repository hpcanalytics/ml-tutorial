...
### Produce multiple diverse candidate solutions for pixel-level semantic photo labeling.
...
### Estimate where on Earth a photo was taken using visual, textual, and temporal features.
...
### Automatically produce diverse captions to describe an image.
